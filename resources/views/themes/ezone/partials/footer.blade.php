        ...
        <div class="container-fluid">
            <div class="widget-wrapper">
                <div class="footer-widget mb-30">
                    <a href="{{ url('/') }}"><img src="{{ asset('themes/ezone/assets/img/logo/logofix.png') }}" alt=""></a>
                    <div class="footer-about-2">
                        <p>Kami siap melayani Anda<br>walau hujan, badai, pandemic sekalipun <br> kami selalu hadir untuk anda</p>
                    </div>
                </div>
                <div class="footer-widget mb-30">
                    ...
                    <div class="footer-info-wrapper-3">
                        <div class="footer-address-furniture">
                            ...
                            <div class="footer-info-content3">
                                <p>Jl. Lewa No 2 <br>DKI Jakarta - Jakarta Timur</p>
                            </div>
                        </div>
                        <div class="footer-address-furniture">
                            <div class="footer-info-icon3">
                        ...
                        <div class="footer-address-furniture">
                            ...
                            <div class="footer-info-content3">
                                <p>helper@merry-boutique.my.id<br></p>
                            </div>
                        </div>
                    </div>
                </div>
